...
class Training(object):
    ...
    def __init__(self, learning_rate, batch_size, iter_num, sequence_size, vector_size, drop_out_rate = 0.7, early_stop_count=3):
    ...
    def train(self, x_data, y_data):
        ...
        while epoch <= self.training_iters:
            ...
            if epoch % self.display_step == 0:
                ...
                if (avg_loss < 0.0001):
                    self.saver.save(session, self.whitespace_model_file)
                    break
                start_time = time.time()
    ...
    def predict(self, x_data, sentence):
        ...
        saver.restore(session, self.whitespace_model_file)
